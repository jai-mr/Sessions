...
def grad_cam(img_tensor, plus,method,out_img_path):
    ...
    plt.imsave(out_img_path, visualization)
...
def explainable_out(img_path, method='ig'):
    ...
    print("*---------------------- " + method + " ----------------------*" )
    if method == "gc":
        plt_fig = grad_cam(img_tensor,False,method,out_img_path)
        #plt_fig.savefig(out_img_path)
        return plt_fig
    if method == "gcp":
        plt_fig = grad_cam(img_tensor, True,method,out_img_path)
        #plt_fig.savefig(out_img_path)
        return plt_fig
